...
import {
    Save, Send, ImagePlus, X, Loader2, Eye, EyeOff,
    ArrowLeft, FileText
} from 'lucide-react';
        ...
        <div className="w-full max-w-5xl mx-auto px-4 py-8">
            ...
            {previewMode ? (
                ...
                <div className="p-8 bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-2xl">
                    ...
                    {formData.excerpt && (
                        <p className="text-xl text-zinc-400 mb-6">{formData.excerpt}</p>
                    )}
                    <div className="prose prose-invert max-w-none">
                        <pre className="whitespace-pre-wrap text-zinc-300">{formData.content || 'No content yet...'}</pre>
                    </div>
                </div>
            ) : (
                /* Edit Mode */
